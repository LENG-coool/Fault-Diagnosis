...
## От маргинального вклада к значениям SHAP{#shap}
...
## Tree SHAP: ускорение вычислений{#tree}
...
## Анализ интерпретируемости (на примере износа поршневых колец — неисправность F4){#анализ}
![图片描述](/ru图片2.png)
...
## Оригинальная литература{#литература}
